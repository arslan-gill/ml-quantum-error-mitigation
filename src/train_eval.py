...
DATA_PATH = "/home/claude/qem_project/data/dataset.csv"
RESULTS_PATH = "/home/claude/qem_project/results/metrics.json"
...
def main():
    ...
    np.savez(
        "/home/claude/qem_project/results/predictions.npz",
    ...
    with open("/home/claude/qem_project/results/feature_importances.json", "w") as f:
